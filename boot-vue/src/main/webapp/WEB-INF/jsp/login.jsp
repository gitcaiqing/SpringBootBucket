...
<div id="main">
    ...
    <form action="${pageContext.request.contextPath}/login" method="post" class="form">
        ...
        <div class="form-body">
            ...
            <div class="ui-input">
                记住我<input style="width: 25px; height: 25px; margin-left: 20px" type="checkbox" placeholder="记住我"
                          name="remember-me" value="true"/>
            </div>
            <div class="ui-input">
                <input type="text" placeholder="请输入验证码" name="captcha" style="float:left;width:75%"
                       oninput="inputFocus(this)"/>
            ...
            <button type="submit" class="ui-button ui-button--primary"
                    style="background-color:#409eff;margin-bottom:20px">登录
            </button>
